...
export default function NaturalMixCard({ product }: { product: HoneyProduct }) {
  ...
  return (
    <Link href={`/products/${product.id}`} className="block">
      ...
      >
        <div className="pointer-events-none absolute -inset-px rounded-[1.75rem] opacity-[0.48] blur-2xl">
            ...
            {hasImage ? (
              ...
              <div className="relative h-full w-full">
                ...
                <div className="absolute inset-0 grid place-items-center p-6">
                  <div className="w-full max-w-xs rounded-[1.35rem] border border-[rgba(217,164,65,0.3)] bg-[rgba(11,9,7,0.68)] p-6 text-center backdrop-blur-md">
                    <motion.div
